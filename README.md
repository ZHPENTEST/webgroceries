...
- V2: delivery zones by postcode, loyalty points (earn/redeem), weekly subscription boxes + cron, admin banners, PWA (offline + install), auto DB backup + restore, BM/EN toggle, transfer QR + claim verify, COD change info, map pin picker.
