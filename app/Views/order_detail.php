...
<div class="card"><h3>Delivery</h3><p><?= e($o['recipient']) ?> · <?= e($o['phone']) ?><br><?= e($o['address_line']) ?>, <?= e($o['city']) ?> <?= e($o['postcode']) ?></p><p>Payment: <?= e($o['payment_method']) ?> (<?= e($o['payment_status']) ?><?php if (($pay['status'] ?? '') === 'claimed'): ?> · menunggu pengesahan admin<?php endif; ?>)</p>
